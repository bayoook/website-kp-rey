                        ...
                        <form method="POST" enctype="multipart/form-data" action="<?= base_url() ?>admin/<?php if ($title == 'Tambah User') echo 'proses_tambah_user';
                            ...
                            <div class="p-5">
                                ...
                                <div class="form-group row">
                                    ...
                                    <?php } else { ?>
                                        <div class="col">
                                            <input class="form-control form-control-user" type="file" accept="image/*" name="photo" value="<?= base_url() . 'uploads/' . $user_edit['photo'] ?>" />
                                        </div>
                                    <?php } ?>
                                </div>
                                <hr>
                                    ...
                                    <div class="col">
                                        <select class="form-control form-control-user" name="status">
                                            ...
                                            <?php foreach ($status as $rows) { ?>
                                                <option value="<?= $rows['id_status'] ?>" <?php if ($rows['id_status'] == $user_edit['status']) echo "selected"; ?>>
                                                    <?= $rows['nama_status'] ?>
                                                <?php } ?>
                                        </select>
                                    </div>
