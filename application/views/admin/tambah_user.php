            <div class="container-fluid" style="margin-top:30px">
                <div class="card shadow" style="max-width:850px;">
                    ...
                    <form id="ganti_gambar" method="POST" enctype="multipart/form-data"
                        action="<?= base_url() ?>admin/ganti_gambar/<?= $user_edit['id'] ?>/<?php if ($title == 'Tambah User') echo 'tambah';
                    ...
                    <form id="hapus_gambar" method="POST" enctype="multipart/form-data"
                        action="<?= base_url() ?>admin/delete_image/<?= $user_edit['id'] ?>">
                    ...
                    <div class="card-body">
                        <form method="POST" enctype="multipart/form-data"
                            action="<?= base_url() ?>admin/<?php if ($title == 'Tambah User') echo 'proses_tambah_user';
                            ...
                            <div class="p-5">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col"><input class="form-control form-control-user" type="password"
                                            name="password" /></div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-3" style="align-items:center; display:flex">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col"><input class="form-control form-control-user" type="text"
                                            name="first_name" value="<?= $user_edit['first_name'] ?>" /></div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-3" style="align-items:center; display:flex">
                                    ...
                                    <div class="col"><input class="form-control form-control-user" type="text"
                                            name="last_name" value="<?= $user_edit['last_name'] ?>" /></div>
                                </div>
                                <hr>
                                <div class="form-group row">
                                    <div class="col-md-3" style="align-items:center; display:flex">
                                    ...
                                    <div class="col"><input class="form-control form-control-user" type="text"
                                            name="no_telp" value="<?= $user_edit['no_telp'] ?>" /></div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-3" style="align-items:center; display:flex">
                                    ...
                                    <div class="col">
                                        <textarea class="form-control form-control-user" rows="4"
                                            name="alamat"><?= $user_edit['alamat'] ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-2">
                                        <img id="image_profile" class="rounded-circle"
                                    ...
                                    <div class="col flex d-flex align-items-center text-center">
                                        <div class=row>
                                            <div class="col flex d-flex align-items-center text-center"
                                                style="padding:10px">
                                                <input class="btn btn-info btn-md" type="button"
                                                    onclick="document.getElementById('selectedFile').click();"
                                                    value="Change Image">
                                            </div>
                                            <div class="col flex d-flex align-items-center text-center"
                                                style="padding:10px">
                                                <input class="btn btn-danger btn-md" type="button"
                                    ...
                                    <?php } else { ?>
                                    <div class="col">
                                        <input class="form-control form-control-user" type="file" name="photo"
                                            value="<?= base_url() . 'uploads/' . $user_edit['photo'] ?>" />
                                    </div>
                                    <?php } ?>
                                </div>
                                <hr>
                                    ...
                                    <div class="col">
                                        <select class="form-control form-control-user" name="status">
                                            ...
                                            <option value="<?= $rows['id_status'] ?>"
                                                <?php if ($rows['id_status'] == $user_edit['status']) echo "selected"; ?>>
                                                <?= $rows['nama'] ?>
                                                <?php } ?>
                                        </select>
                                    </div>
                                </div>
                                <button class="btn btn-primary btn-block text-white btn-user" style="margin-top:50px"
