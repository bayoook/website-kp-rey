        ...
        <div class="col-lg-4 col-xl-4">
            <div class="card shadow mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h6 class="text-primary font-weight-bold m-0">Testing</h6>
                </div>
                <div class="card-body">
                    <div class="chart-area">
                        <canvas data-bs-chart='{"type":"bar",
                            "data":{"labels":["Regional 1","Regional 2","Regional 3","Regional 4","Regional 5","Regional 6"],
                            "datasets":[{"label":"DES","backgroundColor":"#4e73df","borderColor":"#000","data":["12","3","2","9","7","10"]},
                                        {"label":"DBS","backgroundColor":"#df4e4e","borderColor":"#000","data":["3","7","1","6","2","8"]},
                                        {"label":"DBS","backgroundColor":"#62df4e","borderColor":"#000","data":["3","7","1","6","2","8"]}]},
