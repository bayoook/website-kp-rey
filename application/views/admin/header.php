...
<body id="page-top">
    <div id="wrapper">
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" style="background-image: url('none');">
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    <li class="nav-item" role="presentation"><a class="nav-link <?php if ($title == 'Dashboard') echo "active disabled"; ?>" href="<?= base_url() ?>admin/dashboard"><i class="fas fa-tachometer-alt"></i><span>Dashboard</span></a></li>
                    <li class="nav-item" role="presentation"><a class="nav-link <?php if ($title == 'Profile') echo "active disabled"; ?>" href="<?= base_url() ?>admin/profile"><i class="fas fa-user"></i><span>Profile</span></a></li>
                    <li class="nav-item" role="presentation"><a class="nav-link <?php if ($title == 'User') echo "active disabled"; ?>" href="<?= base_url() ?>admin/user"><i class="fas fa-user-circle"></i><span>User</span></a>
                    </li>
                    <li class="nav-item" role="presentation"><a class="nav-link" href="<?= base_url() ?>forgot-password.html"><i class="fas fa-key"></i><span>Forgotten Password</span></a></li>
                    <li class="nav-item" role="presentation"><a class="nav-link <?php if ($title == 'Upload') echo "active"; ?>" href="<?= base_url() ?>admin/upload"><i class="fas fa-file-upload"></i><span>File Upload</span></a></li>
                </ul>
                        ...
                        <ul class="nav navbar-nav flex-nowrap ml-auto">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                ...
                                <div class="dropdown-menu shadow dropdown-menu-right animated--grow-in" role="menu">
                                    ...
                                    <a class="dropdown-item disabled" role="presentation" style="margin-top:-10px">
                                        <?= $user['status_name'] ?>
                                    </a>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item " role="presentation" href="<?= base_url() ?>admin/profile/<?= $user['id'] ?>">
