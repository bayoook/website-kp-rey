                                    ...
                                    <div class="card shadow mb-3">
                                        ...
                                        <div class="card-body">
                                            <div class="form-row">
                                                ...
                                                <div class="col">
                                                    <div class="form-group"><label for="email"><strong>Email Address</strong></label><input class="form-control" type="text" value="<?= $user['email'] ?>" name="email"></div>
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="col">
                                            ...
                                            <div class="form-row">
                                                <div class="col-6">
                                                    <div class="form-group"><label for="first_name"><strong>No Telpon</strong></label><input class="form-control" type="text" value="<?= $user['no_telp'] ?>" name="no_telp"></div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="form-group"><label for="first_name"><strong>Status&nbsp;</strong><strong class="text-danger">(Uneditable)</strong></label><input readonly class="form-control" type="text" value="<?= $user['status_name'] ?>" name=""></div>
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="col">
