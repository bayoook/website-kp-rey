                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group"><label for="email"><strong>Email
                                                            Address</strong></label><input class="form-control" type="text" value="<?= $user['email'] ?>" name="email">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="col-md-6">
                                                <div class="form-group"><label for="first_name"><strong>First
                                                            Name</strong></label><input class="form-control" type="text" value="<?= $user['first_name'] ?>" name="first_name"></div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group"><label for="last_name"><strong>Last
                                                            Name</strong></label><input class="form-control" type="text" value="<?= $user['last_name'] ?>" name="last_name"></div>
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="col-md-6">
                                                <div class="form-group"><label for="first_name"><strong>No
                                                            Telpon</strong></label><input class="form-control" type="text" value="<?= $user['no_telp'] ?>" name="no_telp">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group"><label for="first_name"><strong>Status&nbsp;</strong><strong class="text-danger">(Uneditable)</strong></label><input readonly class="form-control" type="text" value="<?= $user['nama_status'] ?>" name=""></div>
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="col">
                                                <div class="form-group"><label for="first_name"><strong>Alamat</strong></label><textarea class="form-control" type="text" rows="4" name="alamat"><?= $user['alamat'] ?></textarea></div>
                                            </div>
                                        </div>
                    ...
                    <div class="col-xl-3">
                        <div class="card mb-3">
                            <div class="card-body text-center shadow">
                                <img id="image_profile" class="rounded-circle mb-3 mt-4" src="<?= base_url() ?>uploads/<?php if (isset($_SESSION['photo_se']))
                                                                                                                            echo $_SESSION['photo_se'];
                                                                                                                        else if ($user['photo'] != "" or $user['photo'] != null)
                                                                                                                            echo $user['photo'];
                                                                                                                        else
                                                                                                                            echo 'avatar-default.png' ?>" width="160" height="160">
                                <div class="mb-3">
                                    <input name="photo" value="<?php if (isset($_SESSION['photo_se'])) echo $_SESSION['photo_se'];
                                                                else echo $user['photo'] ?>" hidden>
                                    <input class="btn btn-primary btn-sm" type="button" onclick="document.getElementById('selectedFile').click();" value="Change Image">
                                    <input class="btn btn-danger btn-sm" type="button" onclick="document.getElementById('deletedFile').click();" value="Delete Image">
                                </div>
                            </div>
                        </div>
                    </div>
